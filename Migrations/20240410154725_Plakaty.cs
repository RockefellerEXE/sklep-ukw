    ...
    public partial class Plakaty : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyColumn: "FilmId",
                keyValue: 1,
                columns: new[] { "AddDate", "Desc", "Director", "Price", "Title" },
                values: new object[] { null, "Rodzina zamieszkuje opuszczony hotel, gdzie ojciec zaczyna stopniowo tracić zmysły.", "Stanley Kubrick", null, "The Shining" });

            migrationBuilder.UpdateData(
                table: "Films",
                keyColumn: "FilmId",
                keyValue: 2,
                columns: new[] { "AddDate", "CategoryId", "Desc", "Director", "Price", "Title" },
                values: new object[] { null, 1, "Kobieta trafia do odległego motelu, gdzie właściciel ma mroczne sekrety.", "Alfred Hitchcock", null, "Psycho" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "AddDate", "CategoryId", "Desc", "Director", "Price", "Title" },
                values: new object[] { null, 2, "Seria dokumentalna przedstawiająca niesamowite zjawiska przyrody na całym świecie.", "David Attenborough", null, "Planet Earth II" });
        }
    }
}
